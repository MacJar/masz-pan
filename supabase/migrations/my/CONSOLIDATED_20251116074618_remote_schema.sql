...
ALTER TYPE "public"."award_kind" OWNER TO "postgres";
...
ALTER TYPE "public"."ledger_kind" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid") RETURNS json
...
ALTER FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid", "p_amount" integer DEFAULT 2) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid", "p_amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid") RETURNS json
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
declare
  bonus_amount int := 10;
...
ALTER FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid", "p_amount" integer DEFAULT 5) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid", "p_amount" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."claim_rescue_token"("p_user_id" "uuid", "p_amount" integer DEFAULT 1) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."claim_rescue_token"("p_user_id" "uuid", "p_amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."ensure_reservation_owner_consistency"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
  tool_owner uuid;
...
ALTER FUNCTION "public"."ensure_reservation_owner_consistency"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."fts_polish_or_simple"("input" "text") RETURNS "tsvector"
...
ALTER FUNCTION "public"."fts_polish_or_simple"("input" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_counterparty_contact"("p_reservation_id" "uuid") RETURNS TABLE("owner_email" "text", "borrower_email" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."get_counterparty_contact"("p_reservation_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."guard_ratings_after_return"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
...
ALTER FUNCTION "public"."guard_ratings_after_return"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."guard_reservations_parties_immutable"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER FUNCTION "public"."guard_reservations_parties_immutable"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_after" "jsonb" DEFAULT NULL::"jsonb") RETURNS TABLE("id" "uuid", "name" "text", "distance_m" real, "main_image_url" "text", "cursor_key" "jsonb")
    LANGUAGE "plpgsql"
    AS $$
declare
...
ALTER FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_after" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_max_distance_m" integer DEFAULT 50000, "p_after" "jsonb" DEFAULT NULL::"jsonb") RETURNS TABLE("id" "uuid", "name" "text", "distance_m" real, "main_image_url" "text", "owner_name" "text", "cursor_key" "jsonb")
    LANGUAGE "plpgsql"
    AS $$
declare
  v_user_location geography;
...
ALTER FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_max_distance_m" integer, "p_after" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."public_nearby_tools"("p_lon" double precision, "p_lat" double precision, "p_limit" integer, "p_max_distance_m" integer DEFAULT 50000, "p_after" "jsonb" DEFAULT NULL::"jsonb") RETURNS TABLE("id" "uuid", "name" "text", "distance_m" real, "main_image_url" "text", "owner_name" "text", "cursor_key" "jsonb")
    LANGUAGE "plpgsql"
    AS $$
declare
...
ALTER FUNCTION "public"."public_nearby_tools"("p_lon" double precision, "p_lat" double precision, "p_limit" integer, "p_max_distance_m" integer, "p_after" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."publish_tool"("tool_id_to_publish" "uuid") RETURNS TABLE("id" "uuid", "owner_id" "uuid", "name" "text", "description" "text", "suggested_price_tokens" integer, "status" "public"."tool_status", "created_at" timestamp with time zone, "updated_at" timestamp with time zone, "archived_at" timestamp with time zone, "images" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    tool_owner_id UUID;
...
ALTER FUNCTION "public"."publish_tool"("tool_id_to_publish" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."raise_if_reservation_status_changed"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER FUNCTION "public"."raise_if_reservation_status_changed"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."reservation_transition"("p_reservation_id" "uuid", "p_new_status" "public"."reservation_status", "p_price_tokens" smallint DEFAULT NULL::smallint, "p_cancelled_reason" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."reservation_transition"("p_reservation_id" "uuid", "p_new_status" "public"."reservation_status", "p_price_tokens" smallint, "p_cancelled_reason" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."search_public_tools"("p_search_query" "text" DEFAULT NULL::"text", "p_category_slug" "text" DEFAULT NULL::"text") RETURNS TABLE("id" "uuid", "name" "text", "description" "text", "brand" "text", "model" "text", "ownerId" "uuid", "categoryId" "uuid", "imageUrl" "text", "imageUrls" "text"[], "isAvailable" boolean, "location" "public"."geography", "dailyPrice" numeric, "hourlyPrice" numeric, "city" "text", "category_name" "text", "category_slug" "text", "ownerName" "text")
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."search_public_tools"("p_search_query" "text", "p_category_slug" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."search_tools"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb" DEFAULT NULL::"jsonb") RETURNS TABLE("id" "uuid", "name" "text", "distance_m" real, "main_image_url" "text", "owner_name" "text", "cursor_key" "jsonb")
    LANGUAGE "plpgsql"
    AS $$
declare
  v_user_location geography;
...
ALTER FUNCTION "public"."search_tools"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."search_tools_with_images"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb" DEFAULT NULL::"jsonb") RETURNS TABLE("id" "uuid", "name" "text", "distance_m" real, "main_image_storage_key" "text", "cursor_key" "jsonb")
    LANGUAGE "plpgsql" STABLE
    AS $$
declare
...
ALTER FUNCTION "public"."search_tools_with_images"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."tools_search_tsv_trigger"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER FUNCTION "public"."tools_search_tsv_trigger"() OWNER TO "postgres";
...
ALTER TABLE "public"."award_events" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    CONSTRAINT "profiles_username_check" CHECK (("username" OPERATOR("public".<>) ''::"public"."citext"))
);
...
ALTER MATERIALIZED VIEW "public"."rating_stats" OWNER TO "postgres";
...
ALTER TABLE "public"."rescue_claims" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."reservations" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "reservations_agreed_price_tokens_check" CHECK ((("agreed_price_tokens" >= 1) AND ("agreed_price_tokens" <= 255))),
    CONSTRAINT "reservations_check" CHECK (("owner_id" <> "borrower_id"))
);
...
CREATE TABLE IF NOT EXISTS "public"."tools" (
    ...
    "status" "public"."tool_status" DEFAULT 'draft'::"public"."tool_status" NOT NULL,
    "search_name_tsv" "tsvector",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "archived_at" timestamp with time zone,
    CONSTRAINT "tools_suggested_price_tokens_check" CHECK ((("suggested_price_tokens" >= 1) AND ("suggested_price_tokens" <= 5)))
);
...
ALTER TABLE ONLY "public"."award_events"
    ADD CONSTRAINT "award_events_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."award_events"
    ADD CONSTRAINT "award_signup_unique" UNIQUE ("user_id") DEFERRABLE;
...
ALTER TABLE ONLY "public"."ratings"
    ADD CONSTRAINT "ratings_reservation_id_rater_id_key" UNIQUE ("reservation_id", "rater_id");



ALTER TABLE ONLY "public"."rescue_claims"
    ADD CONSTRAINT "rescue_claims_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rescue_claims"
    ADD CONSTRAINT "rescue_claims_user_id_claim_date_cet_key" UNIQUE ("user_id", "claim_date_cet");
...
ALTER TABLE ONLY "public"."tool_images"
    ADD CONSTRAINT "tool_images_tool_id_position_key" UNIQUE ("tool_id", "position");
...
CREATE OR REPLACE TRIGGER "ratings_after_return_guard" BEFORE INSERT ON "public"."ratings" FOR EACH ROW EXECUTE FUNCTION "public"."guard_ratings_after_return"();



CREATE OR REPLACE TRIGGER "reservations_owner_consistency" BEFORE INSERT OR UPDATE OF "tool_id", "owner_id" ON "public"."reservations" FOR EACH ROW EXECUTE FUNCTION "public"."ensure_reservation_owner_consistency"();



CREATE OR REPLACE TRIGGER "reservations_parties_immutable" BEFORE UPDATE OF "owner_id", "borrower_id" ON "public"."reservations" FOR EACH ROW EXECUTE FUNCTION "public"."guard_reservations_parties_immutable"();



CREATE OR REPLACE TRIGGER "reservations_prevent_direct_status" BEFORE UPDATE OF "status" ON "public"."reservations" FOR EACH ROW EXECUTE FUNCTION "public"."raise_if_reservation_status_changed"();
...
CREATE OR REPLACE TRIGGER "set_timestamp_reservations" BEFORE UPDATE ON "public"."reservations" FOR EACH ROW EXECUTE FUNCTION "public"."set_current_timestamp_updated_at"();



CREATE OR REPLACE TRIGGER "set_timestamp_tools" BEFORE UPDATE ON "public"."tools" FOR EACH ROW EXECUTE FUNCTION "public"."set_current_timestamp_updated_at"();



CREATE OR REPLACE TRIGGER "token_ledger_block_delete" BEFORE DELETE ON "public"."token_ledger" FOR EACH ROW EXECUTE FUNCTION "public"."block_update_delete"();



CREATE OR REPLACE TRIGGER "token_ledger_block_update" BEFORE UPDATE ON "public"."token_ledger" FOR EACH ROW EXECUTE FUNCTION "public"."block_update_delete"();



CREATE OR REPLACE TRIGGER "tools_search_tsv" BEFORE INSERT OR UPDATE OF "name" ON "public"."tools" FOR EACH ROW EXECUTE FUNCTION "public"."tools_search_tsv_trigger"();
...
ALTER TABLE ONLY "public"."audit_log"
    ADD CONSTRAINT "audit_log_reservation_id_fkey" FOREIGN KEY ("reservation_id") REFERENCES "public"."reservations"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."award_events"
    ADD CONSTRAINT "award_events_tool_id_fkey" FOREIGN KEY ("tool_id") REFERENCES "public"."tools"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."award_events"
    ADD CONSTRAINT "award_events_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."ratings"
    ADD CONSTRAINT "ratings_rated_user_id_fkey" FOREIGN KEY ("rated_user_id") REFERENCES "public"."profiles"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."ratings"
    ADD CONSTRAINT "ratings_rater_id_fkey" FOREIGN KEY ("rater_id") REFERENCES "public"."profiles"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."ratings"
    ADD CONSTRAINT "ratings_reservation_id_fkey" FOREIGN KEY ("reservation_id") REFERENCES "public"."reservations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."rescue_claims"
    ADD CONSTRAINT "rescue_claims_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."reservations"
    ADD CONSTRAINT "reservations_borrower_id_fkey" FOREIGN KEY ("borrower_id") REFERENCES "public"."profiles"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."reservations"
    ADD CONSTRAINT "reservations_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."profiles"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."reservations"
    ADD CONSTRAINT "reservations_tool_id_fkey" FOREIGN KEY ("tool_id") REFERENCES "public"."tools"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."token_ledger"
    ADD CONSTRAINT "token_ledger_reservation_id_fkey" FOREIGN KEY ("reservation_id") REFERENCES "public"."reservations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."token_ledger"
    ADD CONSTRAINT "token_ledger_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."tools"
    ADD CONSTRAINT "tools_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."profiles"("id") ON DELETE RESTRICT;
...
CREATE POLICY "tool_images_cud_auth" ON "public"."tool_images" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."tools" "t"
  WHERE (("t"."id" = "tool_images"."tool_id") AND ("t"."owner_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."tools" "t"
  WHERE (("t"."id" = "tool_images"."tool_id") AND ("t"."owner_id" = "auth"."uid"())))));



CREATE POLICY "tool_images_select_anon" ON "public"."tool_images" FOR SELECT TO "anon" USING ((EXISTS ( SELECT 1
   FROM "public"."tools" "t"
  WHERE (("t"."id" = "tool_images"."tool_id") AND ("t"."status" = 'active'::"public"."tool_status")))));



CREATE POLICY "tool_images_select_auth" ON "public"."tool_images" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."tools" "t"
...
CREATE POLICY "tools_select_anon" ON "public"."tools" FOR SELECT TO "anon" USING (("status" = 'active'::"public"."tool_status"));



CREATE POLICY "tools_select_auth" ON "public"."tools" FOR SELECT TO "authenticated" USING ((("status" = 'active'::"public"."tool_status") OR ("owner_id" = "auth"."uid"())));
...
GRANT ALL ON FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid", "p_amount" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid", "p_amount" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."award_listing_bonus"("p_user_id" "uuid", "p_tool_id" "uuid", "p_amount" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid", "p_amount" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid", "p_amount" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."award_signup_bonus"("p_user_id" "uuid", "p_amount" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."block_update_delete"() TO "anon";
GRANT ALL ON FUNCTION "public"."block_update_delete"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."claim_rescue_token"("p_user_id" "uuid", "p_amount" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."claim_rescue_token"("p_user_id" "uuid", "p_amount" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."claim_rescue_token"("p_user_id" "uuid", "p_amount" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."ensure_reservation_owner_consistency"() TO "anon";
GRANT ALL ON FUNCTION "public"."ensure_reservation_owner_consistency"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."ensure_reservation_owner_consistency"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."fts_polish_or_simple"("input" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."fts_polish_or_simple"("input" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."fts_polish_or_simple"("input" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_counterparty_contact"("p_reservation_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_counterparty_contact"("p_reservation_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_counterparty_contact"("p_reservation_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."guard_ratings_after_return"() TO "anon";
GRANT ALL ON FUNCTION "public"."guard_ratings_after_return"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."guard_ratings_after_return"() TO "service_role";



GRANT ALL ON FUNCTION "public"."guard_reservations_parties_immutable"() TO "anon";
GRANT ALL ON FUNCTION "public"."guard_reservations_parties_immutable"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."guard_reservations_parties_immutable"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_after" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_after" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_after" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_max_distance_m" integer, "p_after" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_max_distance_m" integer, "p_after" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."nearby_tools"("p_user_id" "uuid", "p_limit" integer, "p_max_distance_m" integer, "p_after" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."public_nearby_tools"("p_lon" double precision, "p_lat" double precision, "p_limit" integer, "p_max_distance_m" integer, "p_after" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."public_nearby_tools"("p_lon" double precision, "p_lat" double precision, "p_limit" integer, "p_max_distance_m" integer, "p_after" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."public_nearby_tools"("p_lon" double precision, "p_lat" double precision, "p_limit" integer, "p_max_distance_m" integer, "p_after" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."publish_tool"("tool_id_to_publish" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."publish_tool"("tool_id_to_publish" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."publish_tool"("tool_id_to_publish" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."raise_if_reservation_status_changed"() TO "anon";
GRANT ALL ON FUNCTION "public"."raise_if_reservation_status_changed"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."raise_if_reservation_status_changed"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."reservation_transition"("p_reservation_id" "uuid", "p_new_status" "public"."reservation_status", "p_price_tokens" smallint, "p_cancelled_reason" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."reservation_transition"("p_reservation_id" "uuid", "p_new_status" "public"."reservation_status", "p_price_tokens" smallint, "p_cancelled_reason" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."reservation_transition"("p_reservation_id" "uuid", "p_new_status" "public"."reservation_status", "p_price_tokens" smallint, "p_cancelled_reason" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."search_public_tools"("p_search_query" "text", "p_category_slug" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."search_public_tools"("p_search_query" "text", "p_category_slug" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_public_tools"("p_search_query" "text", "p_category_slug" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."search_tools"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."search_tools"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_tools"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."search_tools_with_images"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."search_tools_with_images"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_tools_with_images"("p_user_id" "uuid", "p_q" "text", "p_limit" integer, "p_after" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."tools_search_tsv_trigger"() TO "anon";
GRANT ALL ON FUNCTION "public"."tools_search_tsv_trigger"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."tools_search_tsv_trigger"() TO "service_role";
...
GRANT ALL ON TABLE "public"."award_events" TO "anon";
GRANT ALL ON TABLE "public"."award_events" TO "authenticated";
GRANT ALL ON TABLE "public"."award_events" TO "service_role";
...
GRANT ALL ON TABLE "public"."rating_stats" TO "anon";
GRANT ALL ON TABLE "public"."rating_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."rating_stats" TO "service_role";
...
GRANT ALL ON TABLE "public"."rescue_claims" TO "anon";
GRANT ALL ON TABLE "public"."rescue_claims" TO "authenticated";
GRANT ALL ON TABLE "public"."rescue_claims" TO "service_role";
